...
{
    [uiscrollview_main setFrame:CGRectMake(0, 0, 320, 200)];
    
    
    CGPoint scrollPoint = CGPointMake(0, 475);
...
-(IBAction)PrintText
{
	...
	int  kanjiMode = [uisegment_kanjiMode selectedSegmentIndex];
	...
	{
		textNSData = [uitextview_texttoprint.text dataUsingEncoding:NSISO2022JPStringEncoding];
	}
