...
-(NSData *)getImageEscPosDataForPrinting
{
	...
	u_int8_t beginingBytes[] = {0x1b, 0x40, 0x1b, 0x58, 0x32, 0x18}; 
	[someData appendBytes:beginingBytes length:6];
	int totalRowCount = 0;
	...
	u_int8_t imageData5[] = {0x1b, 0x4A, 0x78};
	[someData appendBytes:imageData5 length:3];
